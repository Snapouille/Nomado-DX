...
- Added system description font size option
- Added new screen filters  
- Added new colors for the volume indicator  
- Added missing systems  
  
## V 1.09 - (2025 12 08) 
- Fixed the add-on path for per-system music
- Renamed tyrquake and vitaquake2 systems to quake and quake2
  
## V 1.08 - (2025 06 30) 
- Added CRT and Scanlines shader options
...
- Addeded missing collection backgrounds  
...
## V 1.02 - (2025 05 15) 
- Added SaveState, Manuel and RA icons in gamegarousel and grid views
- Added metadata in gamegarousel and grid views
  
## V 1.01 - (2025 05 14)  
- Added a gamecarousel gamelist view
